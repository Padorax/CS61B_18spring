...
public class CommonBugDetector {
    ...
    public static class CommonBugPuzzleState implements WorldState {
        ...
        public Iterable<WorldState> neighbors() {
            ...
            l7.add('c');
            switch (name) {
                case('s'): return createWorldStateList(l1);
                case('a'): return createWorldStateList(l2);
                case('b'): return createWorldStateList(l3);
                case('c'): return createWorldStateList(l4);
                case('d'): return createWorldStateList(l5);
                case('e'): return createWorldStateList(l6);
                case('x'): return createWorldStateList(l7);
                /*
