...
public class Word implements WorldState {
    private static Set<String> words;//stores all nbr of current word
    ...
    @Override
    //both word and goal should be equal
    ...
    //help understand Word of WorldState
    public static void main(String[] args) {
        Word w = new Word("mug", "rug");
        for (WorldState s: w.neighbors()) {
            Word ws = (Word) s;
            System.out.println(ws.word);
        }
    }
}
