...
//*******************************************************************
            /**
            System.out.println("start_lon"+ params.get("start_lon"));
            System.out.println("start_lat"+params.get("start_lat"));
            System.out.println("end_lon"+params.get("end_lon"));
            System.out.println("end_lat"+params.get("end_lat"));
//            System.out.println("route is"+params.get(route));
            System.out.println("route is"+route);*/
//*******************************************************************
            String directions = getDirectionsText();
//            *******************************
            /*
            System.out.print("direction is" + directions);*/
//            *****************************
...
//        **********************************************
        /**
        System.out.println("below route" + route);
        System.out.println("below directions" + directions);*/
//        *********************************************
