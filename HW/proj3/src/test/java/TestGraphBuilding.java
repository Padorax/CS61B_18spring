...
//    my own Test for
    ...
    public void testCustom() {
        long expected = graph.closest(122.25591052627564, 37.86906524922426);
        System.out.println(expected);
//        double ln = graph.getNode(Long.valueOf("4333613293")).lon;
//        double la = graph.getNode(Long.valueOf("4333613293")).lat;
//        System.out.print(ln +", " +la);
    }
}
