...
public class Game {
    ...
    public TETile[][] playWithInputString(String input) {
        ...
        if (input.charAt(0) == 'N') {
            ...
            //draw the world to the screen with HUD
            //ter.initialize(WIDTH, HEIGHT + 3, 0, 2);
    ...
    private static Map loadMap() {
        ...
        if (f.exists()) {
            try {
                ...
                Map loadedMap = (Map) os.readObject();
                os.close();
                return loadedMap;
...
//left to complete
    void drawFrame(TETile[][] world) {
         ...
         */
        /**
        //this will draw the final world using ter.renderFrame
        TERenderer ter = new TERenderer();
        ter.initialize(WIDTH, HEIGHT + 3, 0, 2);
        ter.renderFrame(world);
         */
        StdDraw.clear(new Color(0, 0, 0));
        //this will work using class variable ter
        //ter.renderFrame(world);
        renderCanvas(world);
        StdDraw.show();
    }
    ...
    public void drawStarGUI() {
        ...
        StdDraw.text(midWidth, HEIGHT - 15, "New Game (N)");
    ...
    public static void main(String[] args) {
        Game game = new Game();
        TETile[][] world = game.playWithInputString("N3412SAAAAAAAS:Q");
